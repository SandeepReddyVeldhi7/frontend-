...
import displayINRCurrency from "../help/displayCurrency.js";
...
const ProductDetails = () => {
  ...
  const fetchProductDetails = async () => {
    setLoading(true);
    const response = await fetch(RegisterApi.productDetails.url, {
      method: RegisterApi.productDetails.method,
      headers: {
    ...
    <div className="container mx-auto p-4">
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        <div className="h-96 flex flex-col lg:flex-row-reverse gap-4">
          <div className="h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative my-2 p-1">
            <img
              src={activeImage}
